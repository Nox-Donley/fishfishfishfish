...
rockImg = pygame.image.load("rock.png").convert_alpha()
pygame.Surface.set_colorkey (rockImg, [255,255,255])
rockImg2 = pygame.image.load("rock2.png").convert_alpha()
pygame.Surface.set_colorkey (rockImg2, [255,255,255])
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if mousePos[0]>1000 and mousePos[0] < 1200 and mousePos[1]>50 and mousePos[1]<225:
               background = 1 #castle
                ...
                background = 2 #plants
            elif mousePos[0]>1000 and mousePos[0] < 1200 and mousePos[1]>400 and mousePos[1]<600:
                background = 3 #rock
            ...
            elif mousePos[0]>25 and mousePos[0] < 200 and mousePos[1]>250 and mousePos[1]<350:
               fishieXpos2.append(random.randrange(250, 900))
               fishieYpos2.append(random.randrange(50,750))
            elif mousePos[0]>25 and mousePos[0] < 200 and mousePos[1]>450 and mousePos[1]<550:
